  ...
  if (Meteor.isServer) {
    ...
    Meteor.methods({
      ...
      'getBatteryStatus': function () {
        ...
        res = cmd("python3 " + scriptsPath + "/battery_status.py");
        return res;
      },
      // 'getIsOnline': function() {
      // 	var res;
