  ...
  if (Meteor.isServer) {
    ...
    Meteor.methods({
      ...
      'getInternetSharingStatusEthernet': function () {
        ...
        var sharingFromWlanToEth = commandResult.includes('-A FORWARD -i wlanint -o eth0 -j ACCEPT');
        var sharingToWlanFromEthEstablished = commandResult.includes('-A FORWARD -i eth0 -o wlanint -m state --state RELATED,ESTABLISHED -j ACCEPT');
